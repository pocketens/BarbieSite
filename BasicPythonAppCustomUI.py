...
node_keys = ["3", "4", "5", "6", "7", "8", "9", "12", "14", "16", "21", "23", "35"]
...
nodes["5"]["inputs"]["height"] = 1024
nodes["5"]["inputs"]["batch_size"] = 1
print("Image dimensions set: 512x640")

nodes["9"]["inputs"]["output_directory"] = "R:\\ComfyUI\\ComfyUI_windows_portable\\ComfyUI\\output"
nodes["35"]["inputs"]["output_directory"] = "R:\\ComfyUI\\ComfyUI_windows_portable\\ComfyUI\\output\\Reface"
print("Output directory set:", nodes["9"]["inputs"]["output_directory"])
...
for index, prompt in enumerate(prompt_list):
    ...
    nodes["9"]["inputs"]["filename_prefix"] = fileprefix
